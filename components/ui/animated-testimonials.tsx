...
export const AnimatedTestimonials = ({
  ...
  return (
    <div className="max-w-sm md:max-w-4xl mx-auto antialiased font-sans z-0 px-4 md:px-8 lg:px-12 py-20 z-1">
      <div className="relative grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20">
        <div>
          <div className="relative h-60 md:h-80 w-60 md:w-full">
            <AnimatePresence>
        ...
        <div className="flex justify-between flex-col py-4">
          ...
          >
            ...
            <motion.p className="text-lg text-gray-500 mt-4 md:mt-6 dark:text-neutral-300">
